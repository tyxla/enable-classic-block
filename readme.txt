...
Contributors: tyxla, yuliyan
Tags: classic block, editor, block editor, tinymce, classic editor
...
Makes the Classic block available in the inserter.
...
Manual installation method requires downloading the plugin and uploading it to your web server. The WordPress codex contains [instructions on how to do this here](https://wordpress.org/support/article/managing-plugins/#manual-plugin-installation).
